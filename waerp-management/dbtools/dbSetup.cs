...
namespace waerp_management.dbtools
{
    internal class dbSetup
    {
        ...
        public static bool InitNewDBInstallation()
        {
            ...
            MySqlConnection conn = new MySqlConnection($"Server={InstallationStore.ServerAdress};userid={InstallationStore.DatabaseUser};password={InstallationStore.DatabasePassword};Database={InstallationStore.ServerSchema};Port={InstallationStore.DatabasePort}");
            try
            {
