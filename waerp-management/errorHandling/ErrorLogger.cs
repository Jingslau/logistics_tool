...
namespace waerp_management.errorHandling
{
    ...
    {
        private static string _sqlErrorFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "waerp-stockpilot\\logs\\sql-error.log");
        private static string _sysErrorFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "waerp-stockpilot\\logs\\system-Error.log");
