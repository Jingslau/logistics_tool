...
{
    /// <summary>
    /// Interaction logic for RentNumberInputView.xaml
    /// </summary>
    public partial class RentNumberInputView : Window
    {
        public RentNumberInputView()
        {
            InitializeComponent();
            NumberInput.Text = CurrentRentModel.RentQuantity.ToString();
        }
