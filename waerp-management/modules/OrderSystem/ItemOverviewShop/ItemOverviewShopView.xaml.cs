...
namespace waerp_management.application.OrderSystem
{
    ...
    public partial class ItemOverviewShopView : UserControl
    {
        ...
        private void AddToCart_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                ErrorHandlerModel.ErrorText = "Artikel befindet sich bereits im Warenkorb!";
        ...
        private void AddAllNeeded(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorHandlerModel.ErrorText = "Einige Artikel befinden sich bereits im Warenkorb, bitte leeren!";
                ErrorHandlerModel.ErrorType = "NOTALLOWED";
                ErrorWindow showError = new ErrorWindow();
                showError.ShowDialog();
            }
