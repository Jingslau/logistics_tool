...
{
    /// <summary>
    /// Interaction logic for OrderNumberInputView.xaml
    /// </summary>
    public partial class OrderNumberInputView : Window
    {
        public OrderNumberInputView()
        {
            InitializeComponent();
            NumberInput.Text = ShoppingCartModel.ItemQuantity.ToString();
        }
        ...
        private void SaveNumberInput_Click(object sender, RoutedEventArgs e)
        {
            ...
            ShoppingCartModel.ItemQuantity = NumberInput.Text;
            DialogResult = false;
        }
    }
}
