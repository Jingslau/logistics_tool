...
{
    /// <summary>
    /// Interaction logic for BookOrderNumberInputWindow.xaml
    /// </summary>
    public partial class BookOrderNumberInputWindow : Window
    {
        public BookOrderNumberInputWindow()
        {
            InitializeComponent();
            NumberInput.Text = ActiveOrderModel.BookQuantity.ToString();
        }
        ...
        private void SaveNumberInput_Click(object sender, RoutedEventArgs e)
        {
            ...
            ActiveOrderModel.BookQuantity = NumberInput.Text;
            DialogResult = false;
        }
    }
}
