...
{
    /// <summary>
    /// Interaction logic for RebookNumberInputWindow.xaml
    /// </summary>
    public partial class RebookNumberInputWindow : Window
    {
        public RebookNumberInputWindow()
        {
            InitializeComponent();
            NumberInput.Text = CurrentRebookModel.RebookQuantity.ToString();
        }
        ...
        {
            CurrentRebookModel.RebookQuantity = NumberInput.Text;
            DialogResult = false;
        }
    }
}
