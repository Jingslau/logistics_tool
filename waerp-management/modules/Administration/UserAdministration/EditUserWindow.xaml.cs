...
namespace waerp_management.application.Administration.UserAdministration
{
    ...
    public partial class EditUserWindow : Window
    {
        ...
        public EditUserWindow()
        {
            ...
            user_role.SelectedIndex = int.Parse(currentUser.Tables[0].Rows[0]["role_id"].ToString());
        }
        ...
        private void EditUser_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorHandlerModel.ErrorText = "Die Felder Benutzername, Passwort, Ident.-Nr., Vorname und Nachname dürfen nicht leer sein!";
            ...
            {
                ErrorHandlerModel.ErrorText = "Die Email hat kein gültiges Format!";
                ErrorHandlerModel.ErrorType = "NOTALLOWED";
                ErrorWindow openError = new ErrorWindow();
                openError.ShowDialog();
            }
            else
            {
                ...
                if (check && check2)
                {
                    ErrorHandlerModel.ErrorText = "Der Benutzername und die Identifikationsnummer sind bereits vergeben!";
                    ErrorHandlerModel.ErrorType = "NOTALLOWED";
                    ErrorWindow openError = new ErrorWindow();
                    openError.ShowDialog();
                }
                ...
                {
                    ErrorHandlerModel.ErrorText = "Der Benutzername ist bereits vergeben!";
                    ErrorHandlerModel.ErrorType = "NOTALLOWED";
                    ErrorWindow openError = new ErrorWindow();
                    openError.ShowDialog();
                }
                ...
                {
                    ErrorHandlerModel.ErrorText = "Die Identifikationsnummer ist bereits vergeben!";
                    ErrorHandlerModel.ErrorType = "NOTALLOWED";
                    ErrorWindow openError = new ErrorWindow();
                    openError.ShowDialog();
                }
                else
                {
                    ...
                    {
                        ErrorHandlerModel.ErrorText = "Der Mitarbeiter wurde erfolgreich bearbeitet!";
