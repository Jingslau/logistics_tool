...
{
    /// <summary>
    /// Interaction logic for ReturnNumberInputView.xaml
    /// </summary>
    public partial class ReturnNumberInputView : Window
    {
        public ReturnNumberInputView()
        {
            InitializeComponent();
            NumberInput.Text = CurrentReturnModel.ReturnQuantity.ToString();
        }
        ...
        {
            CurrentReturnModel.ReturnQuantity = NumberInput.Text;
            DialogResult = false;
        }
    }
}
