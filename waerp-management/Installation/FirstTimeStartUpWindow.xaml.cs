...
namespace waerp_management.FirstTimeStartup
{
    ...
    public partial class FirstTimeStartUpWindow : Window
    {
        static class InstallationSave
        {
            ...
            static string folderPath = Path.Combine(appDataFolderPath, "waerp-stockpilot");
            static string standardOrderPath = Path.Combine(folderPath, "Bestellungen");
            ...
            public static string companyMailHost = "";
            public static string companyMailPort = "";
            public static string companyMailPassword = "";
        ...
        {
            Registry.CurrentUser.DeleteSubKey(@"SOFTWARE\wærp-stockpilot");
            System.Windows.Application.Current.Shutdown();
        }
        ...
        {
            RegistryKey key = Registry.CurrentUser.CreateSubKey(@"SOFTWARE\wærp-stockpilot", true);
            currentStep++;
            InstallationTabs.SelectedIndex = currentStep;
        ...
        private void StandardValuesNextBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                InstallationSave.companyMailHost = smtpHost.Text;
                InstallationSave.companyMailPassword = companyMailPassword.Password;
                InstallationSave.companyMailPort = smtpPort.Text;
        ...
        private void TestConnection_Click(object sender, RoutedEventArgs e)
        {
            ...
            MySqlConnection connNew = new MySqlConnection($"Server={ServerAdress.Text};userid={DatabaseUser.Text};password={DatabasePassword.Password}; Port = {DatabasePort.Text}");
            ...
            if (check2 == true)
            {
                ...
                if (check3 == true)
                {
                    try
                    {
                        connNew = new MySqlConnection($"Server={ServerAdress.Text};userid={DatabaseUser.Text};password={DatabasePassword.Password};Database={ServerSchema.Text}; Port={DatabasePort.Text}");
                        connNew.Open();
        ...
        private void SaveValues_Click(object sender, RoutedEventArgs e)
        {
            ...
            InstallationSave.dbPort = DatabasePort.Text;

            SuccessText.Visibility = Visibility.Visible;
            SuccessIcon.Visibility = Visibility.Visible;

            MySqlConnection connNew = new MySqlConnection($"Server={ServerAdress.Text};userid={DatabaseUser.Text};password={DatabasePassword.Password};Database={ServerSchema.Text}; Port={DatabasePort.Text}");
            connNew.Open();
        ...
        private void FinishInstallationBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            key.SetValue("DBPort", InstallationSave.dbPort.ToString());
            ...
            key.Close();
            SqlConn.SetConnectionString(InstallationSave.dbServer.ToString(), InstallationSave.dbUser.ToString(), InstallationSave.dbPassword.ToString(), InstallationSave.dbSheme.ToString(), InstallationSave.dbPort.ToString());
            ...
            if (!InstallationSave.jumpToFinish)
            {
                ...
                AdministrationQueries.RunSqlExec($"UPDATE company_settings SET settings_value = '{InstallationSave.companyMailPassword}' WHERE settings_name = 'company_mail_password'");
                AdministrationQueries.RunSqlExec($"UPDATE company_settings SET settings_value = '{InstallationSave.companyMailPort}' WHERE settings_name = 'company_mail_port'");
                AdministrationQueries.RunSqlExec($"UPDATE company_settings SET settings_value = '{InstallationSave.companyMailHost}' WHERE settings_name = 'company_mail_host'");
        ...
        private void ConfigureDB_Click(object sender, RoutedEventArgs e)
        {
            ...
            ConfirmDeleteDatabaseWindow openConfirm = new ConfirmDeleteDatabaseWindow();
